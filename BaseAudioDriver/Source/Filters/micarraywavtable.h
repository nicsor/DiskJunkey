...
#ifndef _BASEAUDIODRIVER_MICARRAYWAVTABLE_H_
#define _BASEAUDIODRIVER_MICARRAYWAVTABLE_H_
...
static
BASEAUDIODRIVER_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
...
#endif // _BASEAUDIODRIVER_MICARRAYWAVTABLE_H_
