...
#ifndef _BASEAUDIODRIVER_MICARRAYTOPO_H_
#define _BASEAUDIODRIVER_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyBaseAudioDriver,
...
public:
    ...
    (
        ...
        CMiniportTopologyBaseAudioDriver(FilterDesc, DeviceMaxChannels),
...
#endif // _BASEAUDIODRIVER_MICARRAYTOPO_H_
