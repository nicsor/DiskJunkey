...
Abstract:
    ...
    Node and Pin numbers and other common definitions for the base audio driver.
--*/

#ifndef _BASEAUDIODRIVER_ENDPOINTS_H_
#define _BASEAUDIODRIVER_ENDPOINTS_H_

// Name Guid
// {0104947F-82AE-4291-A6F3-5E2DE1AD7DC2}
#define STATIC_NAME_BASE_AUDIO_DRIVER\
    0x104947f, 0x82ae, 0x4291, 0xa6, 0xf3, 0x5e, 0x2d, 0xe1, 0xad, 0x7d, 0xc2
DEFINE_GUIDSTRUCT("0104947F-82AE-4291-A6F3-5E2DE1AD7DC2", NAME_BASE_AUDIO_DRIVER);
#define NAME_BASE_AUDIO_DRIVER DEFINE_GUIDNAMED(NAME_BASE_AUDIO_DRIVER)
...
#endif // _BASEAUDIODRIVER_ENDPOINTS_H_
