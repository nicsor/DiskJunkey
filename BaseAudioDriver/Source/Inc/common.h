...
#ifndef _BASEAUDIODRIVER_COMMON_H_
#define _BASEAUDIODRIVER_COMMON_H_
...
//
//=============================================================================
typedef struct _BASEAUDIODRIVER_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} BASEAUDIODRIVER_DEVPROPERTY, PBASEAUDIODRIVER_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with BASEAUDIODRIVER.<TopoName>.szPname in the inf's [Strings] section
    ...
    const BASEAUDIODRIVER_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with BASEAUDIODRIVER.<WaveName>.szPname in the inf's [Strings] section
    ...
    const BASEAUDIODRIVER_DEVPROPERTY*       WaveInterfaceProperties;
...
#endif  //_BASEAUDIODRIVER_COMMON_H_
