...
Abstract:
    ...
    Declaration of Base Audio Driver sine wave generator.
--*/
#ifndef _BASEAUDIODRIVER_TONEGENERATOR_H
#define _BASEAUDIODRIVER_TONEGENERATOR_H
...
#endif // _BASEAUDIODRIVER_TONEGENERATOR_H
