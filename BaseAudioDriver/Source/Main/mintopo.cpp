...
NTSTATUS
CreateMiniportTopologyBaseAudioDriver
( 
...
--*/
{
    ...
    return CMiniportTopologyBaseAudioDriver::GetDescription(OutFilterDescriptor);        
} // GetDescription
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyBaseAudioDriver::Init failed, 0x%x", ntStatus)),
        Done);
