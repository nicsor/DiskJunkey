...
#ifndef _BASEAUDIODRIVER_MINWAVERT_H_
#define _BASEAUDIODRIVER_MINWAVERT_H_
...
#pragma code_seg()
    ...
    friend class        CMiniportTopologyBaseAudioDriver;
...
#endif // _BASEAUDIODRIVER_MINWAVERT_H_
