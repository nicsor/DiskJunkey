...
CMiniportTopologyBaseAudioDriver::CMiniportTopologyBaseAudioDriver
(
...
} // CMiniportTopologyBaseAudioDriver
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyBaseAudioDriver::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyBaseAudioDriver::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyBaseAudioDriver::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyBaseAudioDriver::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyBaseAudioDriver::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyBaseAudioDriver::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyBaseAudioDriver::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyBaseAudioDriver::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyBaseAudioDriver::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyBaseAudioDriver::GenerateEventList]"));
